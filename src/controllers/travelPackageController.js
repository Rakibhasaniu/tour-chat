...
//     travelPackageModel.create(postBody).then((data)=>{
//         res.status(200).json({
//             status:"Success",
//             data: data
//         });
...
//     travelPackageModel.find(query, projection).sort({packageCreatedDate: -1}).then((data)=>{
//         res.status(200).json({
//             status:"Success",
//             data: data
//         })
...
//         reviews
//     };
//     travelPackageModel.updateOne({_id:filter}, {$set:postBody},{upsert:true}).then((data)=>{
//         res.status(200).json({
//             status:"Success",
//             data: data
//         })
...
//     travelPackageModel.deleteOne({_id:_id}).then((data)=>{
//         res.status(200).json({
//             status:"Success",
//             data: data
//         })
