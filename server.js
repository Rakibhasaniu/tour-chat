...
nextApp.prepare().then(() => {
  ...
  // let URI = `mongodb+srv://${process.env.DATABASE_USERNAME}:${process.env.DATABASE_PASSWORD}cluster0.48q4yql.mongodb.net/${process.env.DATABASE_NAME}?retryWrites=true&w=majority`;

  let URI = `mongodb://127.0.0.1:27017/${process.env.DATABASE_USERNAME}`;
  //   let URI = `mongodb+srv://${process.env.DATABASE_USERNAME}:${process.env.DATABASE_PASSWORD}@cluster0.mongodb.net/${process.env.DATABASE_NAME}
  // `;
  let OPTION = {
    autoIndex: true,
  };
